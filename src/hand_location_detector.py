...
class HandLocationDetector:
    ...
    def __init__(self, camera, calibratrion_matrix, tap_receiver_conn, sound_event_sender_conn):
        ...
        while 1:
            ...
            if results.multi_hand_landmarks:
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    self.sound_event_sender_conn.send(SoundEvent(detected_tap.intensity, hand_coordinates[0], hand_coordinates[1]))
